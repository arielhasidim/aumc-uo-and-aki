...
The code above is used to reproduce the validation cohort results for the *Standardizing urine output data for AKI analysis: A multicenter proof of concept study*. (DOI: [XX]()) study.
