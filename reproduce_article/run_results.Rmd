...
pacman::p_load(pacman, DBI, bigrquery, tidyverse, reshape2, finalfit, psych, ggplot2, 
               ...
               ggsci, ggsurvfit, gt, rms, marginaleffects) 
...
akis_all_long <- akis_all_wide %>%
  ...
  left_join((
    table_1 %>%
      select(STAY_ID, admission_age, gender, weight_admit)
  ),
  by = "STAY_ID") %>%
  mutate(
