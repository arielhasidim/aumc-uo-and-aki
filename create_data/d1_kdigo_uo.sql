CREATE OR REPLACE TABLE `aumc_uo_and_aki.d1_kdigo_uo` AS
...
WITH
  ur_stg AS (
    ...
    FROM
      `aumc_uo_and_aki.c_hourly_uo` io
      -- this join gives all UO measurements over the 24 hours preceding this row
      LEFT JOIN `aumc_uo_and_aki.c_hourly_uo` iosum ON io.stay_id = iosum.stay_id
