...
# Title: R workflow for the creation of hourly-adjusted UO and KDIGO stages tables.
# Date: 06-May-2023
...
# Creating new dataset named "aumc_uo_and_aki" in the inside your project:
# (If not exist)
create_dataset <- paste("CREATE SCHEMA IF NOT EXISTS `",billing_account,".aumc_uo_and_aki`", sep = "")
