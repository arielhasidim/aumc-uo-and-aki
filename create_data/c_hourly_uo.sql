CREATE OR REPLACE TABLE `aumc_uo_and_aki.c_hourly_uo` AS
...
-- hour. We only calculate an adjusted value if a valid UO rate is present for 
-- most of the hour.
